              ...
              <tbody className="divide-y">
                {groupedByStatus.map((row) => (
                  <tr key={row.status}>
                    ...
                    <td className="px-4 py-2">{(row._count as any)?.status ?? 0}</td>
                  </tr>
                ))}
              </tbody>
            </table>
              ...
              <tbody className="divide-y">
                {groupedByPhase.map((row) => (
                  <tr key={row.phase}>
                    ...
                    <td className="px-4 py-2">{(row._count as any)?.phase ?? 0}</td>
                  </tr>
                ))}
              </tbody>
            </table>
              ...
              <tbody className="divide-y">
                {groupedByPriority.map((row) => (
                  <tr key={row.priority}>
                    ...
                    <td className="px-4 py-2">{(row._count as any)?.priority ?? 0}</td>
                  </tr>
                ))}
              </tbody>
            </table>
              ...
              <tbody className="divide-y">
                {groupedByType.map((row) => (
                  <tr key={row.projectType}>
                    ...
                    <td className="px-4 py-2">{(row._count as any)?.projectType ?? 0}</td>
                  </tr>
                ))}
              </tbody>
            </table>
